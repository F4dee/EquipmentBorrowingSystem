...
object RetrofitClient {
    ...
    val requestService: edu.cit.lastname.equipmentborrowingsystem.features.borrowing.RequestService by lazy {
        retrofit.create(edu.cit.lastname.equipmentborrowingsystem.features.borrowing.RequestService::class.java)
    }
}
